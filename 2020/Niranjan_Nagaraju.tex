...
%    
	...
	\begin{itemize}
	\itemsep0em
		\item Designed and developed initial prototypes for the backend web API and android application for an IoT-enabled smart-plug. %
		\item Optimized spring-boot/mongodb based backend web API workflows for security and data-usage.%
		\item Authored a python-based automation/testing framework to interact with the smart-plug and the backend web API.%
		\item Optimized micropython-based firmware for the smart-plug to function in an ultra-low resource environment.\vspace{1mm}\\\vspace{1mm}%
	\end{itemize}
   ...
   \textsl{Multi-threading processing layer, `Logicserver', NarusInsight}
	\begin{itemize}
	\itemsep0em
