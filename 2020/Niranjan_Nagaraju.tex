...
%    
	...
	\itemsep0em
		...
		\item Designed a network discovery mechanism for the WiFi-enabled IoT device in a local network, in the absence of traditional discovery mechanisms.\vspace{1mm}\\\vspace{1mm}%
	\end{itemize}
