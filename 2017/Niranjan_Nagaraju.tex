...
%    
	...
	\begin{itemize}
		...
		\item Ported IPS and SSL forward-proxy modules to Intel/Linux-based Next-gen SRX devices.%
	...
	\begin{itemize}
		\item Implemented a pseudo network device driver for a PCI-e based FGPA device emulating the TCP/IP stack in hardware. %
		\item Design and implementation of a dual-stack architecture that enables switching between TOE and the Linux TCP/IP stack. %
	\end{itemize}
	...
	\begin{itemize}
		\item Implemented ICMPv6 NDP (Neighbor Discovery Protocol) and MLD (Multicast Listener Discovery) in software to be integrated with the rest of the IPv6 stack in the TIP6E hardware FPGA. %
	\end{itemize}
...
The idea was to use the online CVE(Common Vulnerabilities and Exposures) database combined with some network information (machines, services running, etc) to improve SRX-IPS attack detection.
